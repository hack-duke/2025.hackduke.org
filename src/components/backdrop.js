        ...
        <div className="relative top-0 left-0 w-full">
            ...
            <Parallax speed={10}>
                <img
                    ...
                    className="absolute right-0 w-[20vw] max-w-none h-auto z-10 transform"
                    style={{ transform: 'translateY(10vw)' }}
                />
                <img
                    src="/images/LeftCliffFrontTop.png"
                    alt="left front top cliff"
                    className="absolute left-0 w-[20vw] max-w-none h-auto z-10 transform"
                    style={{ transform: 'translateY(10vw)' }}
                />
                <img
                ...
                <img src="/images/ScheduleRightSpeaker.png" alt="About Left Speaker"
                    ...
                    style={{ transform: 'translateY(160vw)' }} />
            </Parallax>
        </div>
    );
}